    ...
    <div className='body-home'>
      ...
      <div className="home-container">
        <div className="conteiner-buttons">
          <Link to="/funcionarios" className="icon-button" id='func'>
          ...
          <Link to="/epis" className="icon-button" id='epi'>
          ...
          <Link to="/emprestimos" className="icon-button" id='pegar'>
            ...
            <span>Pegar Epis</span>
          </Link>
          <Link to="/historico" className="icon-button" id='historico'>
